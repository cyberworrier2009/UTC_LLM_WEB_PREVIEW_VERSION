...
export function LikeModal(props) {
        ...
        <div className="w-full flex items-center justify-between">
          <div className="flex items-center">
            <div className="mr-4 flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-full sm:h-10 sm:w-10 bg-green-100">
              <svg stroke="currentColor" fill="none" stroke-width="1.5" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" className="h-6 w-6 text-green-700" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
    ...
    className="text-lg font-medium leading-6 text-gray-900 dark:text-gray-200">
      ...
      <Modal.Body style={{ borderBottom: "none" }}>
        <form>
          <textarea id="feedback-other" placeholder="What do you like about the response?" rows={3} className="mb-1 mt-4 w-full rounded-md dark:bg-gray-800 border outline-none p-2 dark:focus:border-white dark:focus:ring-white" style={{ height: '89.6px', overflowY: 'hidden' }}></textarea>
        </form>
      </Modal.Body>
      <Modal.Footer>
