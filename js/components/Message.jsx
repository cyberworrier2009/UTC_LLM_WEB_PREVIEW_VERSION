...
const Message = (props) => {
    ...
    return (<div className={`group w-full text-gray-800 dark:text-gray-100 border-b border-black/10 dark:border-gray-900/50 ${isUser ? "bg-white" : "bg-gray-50 dark:bg-[#444654]"}`}>
        ...
        <div className="flex flex-row gap-4 md:gap-6 md:max-w-2xl lg:max-w-xl xl:max-w-3xl p-4 md:py-6 lg:px-0 m-auto w-full">
          ...
          <div className="relative flex w-[calc(100%-50px)] flex-col gap-1 md:gap-3 lg:w-[calc(100%-115px)]">
            <div className="flex flex-grow flex-row gap-3 justify-between">
              ...
              {isUser ? (<div className="text-gray-200">
                  <FaEdit className="h-4 w-4  hover:text-gray-600"/>{" "}
                  {/* Edit icon */}
                </div>) : (<div className="text-gray-200 flex items-center" style={{ gap: '7px' }}>
                  <div className="h-4 w-4 inline  hover:text-gray-600" style={{ marginBottom: '7px' }}>
                  <FaThumbsUp onClick={() => setModalShow(true)}/>
                  {/* <LikeModel show={modalShow} onHide={() => setModalShow(false)}/> */}
                  <LikeModal show={modalShow} onHide={() => setModalShow(false)}/>
